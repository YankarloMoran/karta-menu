...
export default function ItemModal({ 
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          <div className='fixed inset-0 z-[60] flex items-center justify-center p-6 border-shadow'>
            {/* Backdrop */}
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <h2 className='text-3xl font-serif font-bold mb-2'>Nuevo Plato</h2>
              <p className='text-sm text-foreground/60 mb-8'>Define los detalles para que tus clientes se enamoren.</p>
              ...
              <form action={handleSubmit} className='space-y-6'>
                ...
                >
                  {imagePreview ? (
                    ...
                    <div className='text-center space-y-2 flex flex-col items-center'>
                      ...
                      <p className='text-xs text-foreground/40'>Subir foto (JPG, PNG)</p>
                    </div>
                  )}
                  <input 
                    type='file' 
                ...
                <div className='grid md:grid-cols-2 gap-4'>
                  ...
                  <div className='space-y-2'>
                    <label className='text-sm font-medium ml-1 text-primary/60 italic'>Name (English)</label>
                    <input 
                  ...
                  <div className='space-y-2'>
                    <label className='text-sm font-medium ml-1'>Precio ($)</label>
                    <input 
                      type='number' step='0.01' name='price' required placeholder='12.50'
                      className='w-full bg-surface-container-lowest border border-white/5 rounded-xl py-3 px-4 focus:ring-2 focus:ring-primary transition-all outline-none text-foreground'
                    />
                  </div>
                </div>
                ...
                <div className='space-y-4 pt-2 border-t border-white/5'>
                  ...
                  <div className='space-y-2'>
                    <label className='text-xs font-bold text-primary/40 ml-1 italic'>Description (English)</label>
                    <textarea 
                      name='description_en' 
                      rows={2}
                      placeholder='Describe the ingredients in English...'
                ...
                <div className='flex gap-3 pt-2'>
                  ...
                  >
                    {isPending ? <Loader2 className='animate-spin' size={20} /> : 'Guardar Plato'}
                  </button>
                </div>
              </form>
            </motion.div>
