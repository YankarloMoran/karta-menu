    ...
    <header className="relative w-full overflow-hidden">
      ...
      <div className="relative h-48 md:h-64 w-full overflow-hidden">
        ...
        <div className="absolute top-4 left-4 right-4 flex items-center justify-between z-10">
          {tableNumber ? (
            <div className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-slate-900/85 backdrop-blur-md border border-orange-500/30 text-orange-400 font-bold text-xs shadow-lg">
              <MapPin className="w-3.5 h-3.5 animate-bounce text-orange-400" />
      ...
      <div className="max-w-4xl mx-auto px-4 -mt-16 relative z-10 mb-6">
        <div className="glass-panel p-5 rounded-2xl flex flex-col md:flex-row items-start md:items-center gap-4 shadow-2xl border border-white/10">
          <img
            src={restaurant.logo_url}
            alt={restaurant.name}
            className="w-20 h-20 md:w-24 md:h-24 rounded-2xl object-cover border-2 border-orange-500/40 shadow-xl glow-accent flex-shrink-0"
          />
